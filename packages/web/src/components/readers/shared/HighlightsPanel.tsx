...
import type { Highlight, PDFHighlight, EPUBHighlight } from '@pulp/shared';
          ...
          <div className="flex flex-col items-center justify-center h-full text-center px-4">
            ...
            {highlights.length === 0 ? (
              ...
              <>
                ...
                <p className="text-xs text-text-secondary/70">Try adjusting your search</p>
              </>
            )}
          </div>
        ) : (
